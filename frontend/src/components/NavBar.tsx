      ...
      <div className="flex items-center justify-between px-4 py-3 md:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <span className="text-xl font-bold tracking-tight">
            <span className="text-primary">AiChat</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <Button variant="outline" size="lg" className="rounded-md hover:shadow-sm cursor-pointer">
              Sign In
            </Button>
            <Button size="lg" className="rounded-md hover:shadow-sm cursor-pointer">
              Sign Out
            </Button>
          </div>
